...
write.csv(seasonStats,file="SeasonStats.csv")
...
regfit.full=regsubsets(AllStar~.,data = train2000)
summary(regfit.full)

test2001 = test2001[,c(4,6,7,10:15,18,21,22,25,26,28,29,32:35,38,40,41,43,45,49,55,57)]

train2000.results = glm(AllStar~.,data=train2000,family=binomial)
summary(train2000.results)

probs<-predict(train2000.results,test2001,type="response")
pred2001<-rep("0",nrow(test2001))
pred2001[probs>0.5]<-"1"
table(test2001$AllStar,pred2001)
mean(pred2001==test2001$AllStar)
...
train2001.results = glm(AllStar~.,data=train2001,family=binomial)
summary(train2001.results)

probs<-predict(train2001.results,test2002,type="response")
pred2002<-rep("0",nrow(test2002))
pred2002[probs>0.5]<-"1"
table(test2002$AllStar,pred2002)
mean(pred2002==test2002$AllStar)
...
train2002.results = glm(AllStar~.,data=train2002,family=binomial)
summary(train2002.results)

probs<-predict(train2002.results,test2003,type="response")
pred2003<-rep("0",nrow(test2003))
pred2003[probs>0.5]<-"1"
table(test2003$AllStar,pred2003)
mean(pred2003==test2003$AllStar)
...
train2003.results = glm(AllStar~.,data=train2003,family=binomial)
summary(train2003.results)

probs<-predict(train2003.results,test2004,type="response")
pred2004<-rep("0",nrow(test2004))
pred2004[probs>0.5]<-"1"
table(test2004$AllStar,pred2004)
mean(pred2004==test2004$AllStar)
...
train2004.results = glm(AllStar~.,data=train2004,family=binomial)
summary(train2004.results)

probs<-predict(train2004.results,test2005,type="response")
pred2005<-rep("0",nrow(test2005))
pred2005[probs>0.5]<-"1"
table(test2005$AllStar,pred2005)
mean(pred2005==test2005$AllStar)
...
train2005.results = glm(AllStar~.,data=train2005,family=binomial)
summary(train2005.results)

probs<-predict(train2005.results,test2006,type="response")
pred2006<-rep("0",nrow(test2006))
pred2006[probs>0.5]<-"1"
table(test2006$AllStar,pred2006)
mean(pred2006==test2006$AllStar)
...
train2006.results = glm(AllStar~.,data=train2006,family=binomial)
summary(train2006.results)

probs<-predict(train2006.results,test2007,type="response")
pred2007<-rep("0",nrow(test2007))
pred2007[probs>0.5]<-"1"
table(test2007$AllStar,pred2007)
mean(pred2007==test2007$AllStar)
...
train2007.results = glm(AllStar~.,data=train2007,family=binomial)
summary(train2007.results)

probs<-predict(train2007.results,test2008,type="response")
pred2008<-rep("0",nrow(test2008))
pred2008[probs>0.5]<-"1"
table(test2008$AllStar,pred2008)
mean(pred2008==test2008$AllStar)
...
train2008.results = glm(AllStar~.,data=train2008,family=binomial)
summary(train2008.results)

probs<-predict(train2008.results,test2009,type="response")
pred2009<-rep("0",nrow(test2009))
pred2009[probs>0.5]<-"1"
table(test2009$AllStar,pred2009)
mean(pred2009==test2009$AllStar)
...
train2009.results = glm(AllStar~.,data=train2009,family=binomial)
summary(train2009.results)

probs<-predict(train2009.results,test2010,type="response")
pred2010<-rep("0",nrow(test2010))
pred2010[probs>0.5]<-"1"
table(test2010$AllStar,pred2010)
mean(pred2010==test2010$AllStar)
...
train2010.results = glm(AllStar~.,data=train2010,family=binomial)
summary(train2010.results)

probs<-predict(train2010.results,test2011,type="response")
pred2011<-rep("0",nrow(test2011))
pred2011[probs>0.5]<-"1"
table(test2011$AllStar,pred2011)
mean(pred2011==test2011$AllStar)
...
train2011.results = glm(AllStar~.,data=train2011,family=binomial)
summary(train2011.results)

probs<-predict(train2011.results,test2012,type="response")
pred2012<-rep("0",nrow(test2012))
pred2012[probs>0.5]<-"1"
table(test2012$AllStar,pred2012)
mean(pred2012==test2012$AllStar)
...
train2012.results = glm(AllStar~.,data=train2012,family=binomial)
summary(train2012.results)

probs<-predict(train2012.results,test2013,type="response")
pred2013<-rep("0",nrow(test2013))
pred2013[probs>0.5]<-"1"
table(test2013$AllStar,pred2013)
mean(pred2013==test2013$AllStar)
...
train2013.results = glm(AllStar~.,data=train2013,family=binomial)
summary(train2013.results)

probs<-predict(train2013.results,test2014,type="response")
pred2014<-rep("0",nrow(test2014))
pred2014[probs>0.5]<-"1"
table(test2014$AllStar,pred2014)
mean(pred2014==test2014$AllStar)
...
train2014.results = glm(AllStar~.,data=train2014,family=binomial)
summary(train2014.results)

probs<-predict(train2014.results,test2015,type="response")
pred2015<-rep("0",nrow(test2015))
pred2015[probs>0.5]<-"1"
table(test2015$AllStar,pred2015)
mean(pred2015==test2015$AllStar)
...
train2015.results = glm(AllStar~.,data=train2015,family=binomial)
summary(train2015.results)

probs<-predict(train2015.results,test2016,type="response")
pred2016<-rep("0",nrow(test2016))
pred2016[probs>0.5]<-"1"
table(test2016$AllStar,pred2016)
mean(pred2016==test2016$AllStar)
...
train2016.results = glm(AllStar~.,data=train2016,family=binomial)
summary(train2016.results)

probs<-predict(train2016.results,test2017,type="response")
pred2017<-rep("0",nrow(test2017))
pred2017[probs>0.5]<-"1"
table(test2017$AllStar,pred2017)
mean(pred2017==test2017$AllStar)
...
train.results = glm(AllStar~G+GS+FG+Salary+WS+ORB+BLK,data=train,family=binomial)
...
library(pROC)
class.roc<-roc(test$AllStar,probs)
plot(class.roc)
class.roc
...
knn2001.fit = knn(data.frame(knnTrain2000.x),data.frame(knnTest2001.x),knnTrain2000.y,k=10,prob = T)
...
roc(knnTest2001.y, attributes(knn2001.fit)$prob)
plot(roc(knnTest2001.y, attributes(knn2001.fit)$prob),
     print.thres = T,
     print.auc = T)
